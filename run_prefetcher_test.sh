...
mkdir -p ./results-prefetcher-ipcp
mkdir -p ./results-prefetcher-ip_stride
...
do
    ...
    ./bin/prefetcher-test-ipcp --warmup-instructions 200000000 --simulation-instructions 200000000 "$TRACE_DIR/$TRACE" > "./results-prefetcher-ipcp/${TRACE%.xz}.txt" &
    ./bin/prefetcher-test-ip_stride --warmup-instructions 200000000 --simulation-instructions 200000000 "$TRACE_DIR/$TRACE" > "./results-prefetcher-ip_stride/${TRACE%.xz}.txt" &
