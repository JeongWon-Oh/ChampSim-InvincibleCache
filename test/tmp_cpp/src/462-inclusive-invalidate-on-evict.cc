...
SCENARIO("An inclusive block invalidates the upper levels on eviction") {
  GIVEN("Two cache levels with a single inclusive filled block") {
    ...
    CACHE seed_upper{CACHE::Builder{champsim::defaults::default_l1d}
      .name("462-seed-upper")
    ...
    CACHE test_upper{CACHE::Builder{champsim::defaults::default_l1d}
      .name("462-test-upper")
    ...
    CACHE lower{CACHE::Builder{champsim::defaults::default_l2c}
      .name("462-lower")
